...
data=pd.read_csv("/content/Data-cleaning-for-beginners-using-pandas (2).csv")
...
data['salary_range_start'] = data['salary_range_start'].astype('int')
data['salary_range_end'] = data['salary_range_end'].astype('int')
data['Location'] = data['Location'].astype('string')
data['Established'] = data['Established'].astype('string')
...
data1=pd.read_csv("/content/chipotle (1).tsv",sep='\t')
...
data1['1_choice'] = data1['1_choice'].astype('string')
data1['2_choice'] = data1['2_choice'].astype('string')
data1['3_choice'] = data1['3_choice'].astype('string')
data1['4_choice'] = data1['4_choice'].astype('string')
data1['5_choice'] = data1['5_choice'].astype('string')
data1['6_choice'] = data1['6_choice'].astype('string')
data1['7_choice'] = data1['7_choice'].astype('string')
data1['8_choice'] = data1['8_choice'].astype('string')
data1['9_choice'] = data1['9_choice'].astype('string')
data1['10_choice'] = data1['10_choice'].astype('string')
data1['item_name'] = data1['item_name'].astype('string')

data1.info()

df_1=(data1.query("quantity==1")
...
merged_df = pd.merge(data1, df_1, how='left', on='item_name', suffixes=('', 'quantity'))

merged_df

data1['item_price_rel'] = merged_df['quantity'] * merged_df['item_pricequantity']

data1.item_price_rel=data1.item_price_rel.round(decimals=2)
